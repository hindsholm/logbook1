...
angular.module('logbook')
    ...
    .controller('DetailController', function ($http, $log, $routeParams) {
        'use strict';
        ...
        function loadGpx(name) {
            $http.get(name).success(function (data) {
                ...
                vm.tracks = parseGpxTracks(gpx);
                vm.map.center = calculateCenter(vm.tracks);
            });
        }
